...
/* exported symbols build must be marked manually */
#if defined(CTYPES_DLL_EXTERN)
...
DLL_EXTERN void add_complexd(ctypes_dcomplex *, ctypes_dcomplex *, ctypes_dcomplex *);
DLL_EXTERN void mul_complexd(ctypes_dcomplex *, ctypes_dcomplex *, ctypes_dcomplex *);
DLL_EXTERN void rotdist_complexd(ctypes_dcomplex *, double *, double *);
DLL_EXTERN void add_complexld(ctypes_ldcomplex *, ctypes_ldcomplex *, ctypes_ldcomplex *);
DLL_EXTERN void mul_complexld(ctypes_ldcomplex *, ctypes_ldcomplex *, ctypes_ldcomplex *);
DLL_EXTERN void rotdist_complexld(ctypes_ldcomplex *, long double *, long double *);
DLL_EXTERN void add_complexf(ctypes_fcomplex *, ctypes_fcomplex *, ctypes_fcomplex *);
DLL_EXTERN void mul_complexf(ctypes_fcomplex *, ctypes_fcomplex *, ctypes_fcomplex *);
DLL_EXTERN void rotdist_complexf(ctypes_fcomplex *, float *, float *);
DLL_EXTERN ctypes_dcomplex add_complexd_val(ctypes_dcomplex, ctypes_dcomplex);
DLL_EXTERN ctypes_dcomplex mul_complexd_val(ctypes_dcomplex, ctypes_dcomplex);
DLL_EXTERN double rotdist_complexd_val(ctypes_dcomplex, double);
DLL_EXTERN ctypes_ldcomplex add_complexld_val(ctypes_ldcomplex, ctypes_ldcomplex);
DLL_EXTERN ctypes_ldcomplex mul_complexld_val(ctypes_ldcomplex, ctypes_ldcomplex);
DLL_EXTERN long double rotdist_complexld_val(ctypes_ldcomplex, long double);
DLL_EXTERN ctypes_fcomplex add_complexf_val(ctypes_fcomplex, ctypes_fcomplex);
DLL_EXTERN ctypes_fcomplex mul_complexf_val(ctypes_fcomplex, ctypes_fcomplex);
DLL_EXTERN float rotdist_complexf_val(ctypes_fcomplex, float);
